...
export function gitStatus(config: LeastConfig, workspace: Workspace, guard?: PathGuard, filePath?: string): string {
...
export function gitDiff(config: LeastConfig, guard: PathGuard, workspace: Workspace, filePath?: string, staged = false): string {
...
export function gitLog(config: LeastConfig, workspace: Workspace, maxCount = 8): string {

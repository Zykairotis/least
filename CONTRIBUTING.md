...
Least is early. Good contributions make it safer, faster, and easier to explain.
...
- Prefer examples that use `/path/to/repo` and `least.example.com`, not local machine paths.
